...
CLASSPATH=$CLASSPATH:$MAIN_LIB/quartz.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/commons-logging.jar
...
$JAVA_HOME/bin/java -Xms384m -Xmx768m com.zte.ums.an.uni.dsl.conf.cdf.report.ReportServer 1
