 ...
 */
public class SubCollectDbPortDataModel implements ICdfConfigDataModel
{
    @Override
    public String getTitle()
    {
        return "CDF Database Port(Mostly, 1433 for mssql, 1521 for oracle)";
    }
        
    @Override
    public String getCurrValue()
    {
        return CenterToolUtil.getCollectXml().getDbPort();
    }
    ...
    public boolean setNewValue(String newValue)
    {
        ...
        CenterToolUtil.getCollectXml().setDbPort(newValue);
