 ...
 */
public class SubCollectDbUserDataModel implements ICdfConfigDataModel
{
    @Override
    public String getTitle()
    {
        return "CDF Database super user";
    }
        
    @Override
    public String getCurrValue()
    {
        return CenterToolUtil.getCollectXml().getDbSuperUser();
    }
    
    @Override
    public boolean setNewValue(String newValue)
    {
        CenterToolUtil.getCollectXml().setDbSuperUser(newValue);
        return true;
    }
}