...
public class DataAppenderBuffer
{
    ...
    public boolean isEmplty(FileInfo fileInfo)
    {
        return fileToLine.get(getKey(fileInfo)).isEmpty();
    }
