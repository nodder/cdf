 ...
 */
public class DispatchDbIpDataModel implements ICdfConfigDataModel
{
    @Override
    public String getTitle()
    {
        return "EMS Database Server IP";
    }
           
    @Override
    public String getCurrValue()
    {
        return CenterToolUtil.getDispatchXml().getDbServerIp();
    }
    ...
    public boolean setNewValue(String newIP)
    {
        ...
        CenterToolUtil.getDispatchXml().setDbServerIP(newIP);
        return true;
    }
}
