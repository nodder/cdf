 ...
 */
public class SubCollectDbNameDataModel implements ICdfConfigDataModel
{
    @Override
    public String getTitle()
    {
        return "CDF Oracle Database Instance(Only for Oracle, otherwise ignore)";
    }
        
    @Override
    public String getCurrValue()
    {
        return CenterToolUtil.getCollectXml().getDbName();
    }
    
    @Override
    public boolean setNewValue(String newValue)
    {
        CenterToolUtil.getCollectXml().setDbName(newValue);
