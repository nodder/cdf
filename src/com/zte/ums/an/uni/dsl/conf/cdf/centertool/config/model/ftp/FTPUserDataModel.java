 ...
 */
public class FTPUserDataModel implements ICdfConfigDataModel
{
    @Override
    ...
    {
        return CenterToolUtil.getCollectXml().getFTPUser();
    }
    
    @Override
    public boolean setNewValue(String newValue)
    {
        CenterToolUtil.getCollectXml().setFTPUser(newValue);
        return true;
    }
}