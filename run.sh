...
CLASSPATH=$CLASSPATH:$MAIN_LIB/zxnm01-uni-dsl-scm-svr.jar
...
CLASSPATH=$CLASSPATH:$MAIN_LIB/cdf-centertool.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/cdf-svr-mock.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/ums-ftpclient-cdd.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/jboss-common.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/jboss-jmx.jar
CLASSPATH=$CLASSPATH:$MAIN_LIB/jboss-system.jar

export CLASSPATH

umask 000

$JAVA_HOME/bin/java -Xms256m -Xmx512m com.zte.ums.an.uni.dsl.conf.cdf.centertool.MainMenu 1
